...
public class StoreStatic {
    ...
    public static final String ITEM_PREFIX_REGEX = "\\[";
    public static final String ITEM_SUFFIX_REGEX = "\\]";
    public static final String ITEM_PREFIX = "[";
    public static final String ITEM_SUFFIX = "]";
    public static final String ITEM_NAME_QUANTITY_SEPARATOR = "-";
    public static final String POSITIVE_ANSWER = "Y";
    public static final String NEGATIVE_ANSWER = "N";
    public static final String PRODUCTS_LIST_PREFIX = "- ";
}
